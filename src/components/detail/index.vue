<template>
  <div id="detailText" class="detailTransition">
    <Header title="影片详情">
      <i class="iconfont icon-right" @touchstart="hangToBack"></i>
    </Header>
...
export default {
  ...
  mounted() {
    this.axios.get("/api/detailmovie?movieId=" + this.moviesId).then(res => {
...
#detailText.detailTransition {
  animation: 0.3s sliderMove;
}
